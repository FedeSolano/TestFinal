...
use Fede\CRUDBundle\Entity\Article;
use Fede\CRUDBundle\Form\ArticleType;
...
class ArticleController extends Controller
{
    ...
    {
        $article = new Article();
        $form = $this->createForm('Fede\CRUDBundle\Form\ArticleType', $article);
    ...
    {
        $deleteForm = $this->createDeleteForm($article);
        $editForm = $this->createForm('Fede\CRUDBundle\Form\ArticleType', $article);
